	...
	def _download_user_media(self, user_id, dytk, url,metadata):
		...
		while True:
			...
			for aweme in aweme_list:
				...
				# jsonfilename = user_id + '.json'
				# with open(jsonfilename, mode='r', encoding='utf-8') as feedsjson:
	   #  			feeds = json.load(feedsjson)
				# with open(jsonfilename, mode='w', encoding='utf-8') as feedsjson:
				# 	feeds.append(aweme)
				# 	json.dump(feeds, feedsjson)
				# with open(jsonfilename, 'a') as f:
			 #  		json.dump(aweme, f, ensure_ascii=False)
